...
#######################################################################################################################
def predict_cancer(filename):
    imageFilePath = os.path.join(TEST_IMAGES_DIR, filename)
...
def main():
    ...
    for fileName in os.listdir(TEST_IMAGES_DIR):
        ...
        predict_cancer(imageFileWithPath)
        print("---------------------------------------")
    # end for
